...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "src/client.py"

        #Name of program
        self.project_name = "Pong Client"

        #Project url
        self.project_url = "www.ngenia.net"
        ...
        #Auhor of program
        self.author_name = "Johan Bjäreholt"
        self.author_email = "johanthepro@gmail.com"
        self.copyright = "Copyright (c) 2013 Johan."

        #Description
        self.project_description = "Multiplayer Pong client"
